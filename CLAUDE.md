# EasySigns Plugin - Development Context

## Project Overview
A floating text signs plugin for Hytale servers allowing players to place and edit signs with custom text.
...
perm group add Adventure signs.admin
...
### EasySigns Permissions
| Permission | Description |
|------------|-------------|
| `signs.use` | Basic access to place and edit signs |
| `signs.admin` | Admin commands (remove others' signs) |
